    ...
    .then((blogs) => {
      ...
      blogs.forEach((blog) => {
        ...
        blogElement.className =
          "flex flex-col bg-white rounded-lg shadow-md overflow-hidden w-[400px]";
        blogElement.innerHTML = `
            ...
            <div class="px-6 py-4 bg-gray-100 mt-auto">
                ...
                <a href="#" class="text-blue-500 text-sm float-right" onclick="loadBlogDetails(${
                  blog.id
                })">Read more</a>
            </div>
            `;
